...
8. Для найденного квадрата расстояния производится нелинейное масштабирование коэффициента различия ([см. Нелинейное масштабирование коэффициента различия](#нелинейное-масштабирование-коэффициента-различия)).
