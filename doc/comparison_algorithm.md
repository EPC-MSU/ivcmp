...
3. Вычисляется расстояние от точки $p$ до отрезков, образованных точками кривой B: между точками с индексами $i_{min}$ и $i_{min} + 1$, а также $i_{min}$ и $i_{min} - 1$. Из двух вариантов выбирается наименьшее расстояние.
